...
export const saturdayActs: Act[] = [
  ...
  { id: 's-nine-inch', name: 'Nine Inch Noize', stage: 'sahara', start: t(20, 0), end: t(20, 45), picked: 'caitlin', priority: 'want', locked: true },
...
export const saturdayItinerary: ItineraryBlock[] = [
  {
    type: 'meander',
    title: 'Arrive whenever + explore',
    subtitle: 'Easy start — arrive when ready\nWander, grab food, explore\nHead to Mojave by 5:45 for Royel Otis',
    start: t(15, 0),
    end: t(17, 50),
    options: [
  ...
  },
  {
    ...
    who: 'both',
    note: 'Leave ~6:10 for Geese (short walk to Gobi)',
  },
  {
    type: 'act',
    actId: 's-geese',
  ...
  },
  {
    type: 'food',
    title: 'Dinner',
    subtitle: 'Eat before Nine Inch Noize\nGet food + head to Sahara by 8',
    start: t(19, 0),
    end: t(20, 0),
    options: [
  ...
  },
  {
    ...
    who: 'caitlin',
    note: 'Leave ~8:50 for good spot at The Strokes',
  },
  {
    type: 'act',
    actId: 's-the-strokes',
