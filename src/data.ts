...
export const fridayActs: Act[] = [
  ...
  { id: 'f-dl-aeon-mode', name: 'Aeon:Mode x Blossom', stage: 'dolab', start: t(19, 10), end: t(20, 25) },
  { id: 'f-dl-level-up', name: 'Level Up x Mary Droppinz', stage: 'dolab', start: t(20, 25), end: t(21, 40) },
