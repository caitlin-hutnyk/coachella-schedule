...
export const fridayActs: Act[] = [
  ...
  { id: 'f-the-xx', name: 'The xx', stage: 'coachella', start: t(19, 0), end: t(19, 55), picked: 'you', priority: 'want' },
  { id: 'f-sabrina', name: 'Sabrina Carpenter', stage: 'coachella', start: t(21, 0), end: t(22, 40), picked: 'both', priority: 'want' },
  { id: 'f-anyma', name: 'Anyma', stage: 'coachella', start: t(24, 0), end: t(25, 0), picked: 'you', priority: 'want', tentative: true },
  ...
  { id: 'f-disclosure', name: 'Disclosure', stage: 'outdoor', start: t(22, 40), end: t(23, 55), picked: 'you', priority: 'want', tentative: true },
  ...
  { id: 'f-blood-orange', name: 'Blood Orange', stage: 'mojave', start: t(24, 0), end: t(24, 55), picked: 'you', priority: 'want' },
  ...
  { id: 'f-marlon', name: 'Marlon Hoffstadt', stage: 'sahara', start: t(18, 15), end: t(19, 15), picked: 'you', priority: 'want' },
  { id: 'f-katseye', name: 'KATSEYE', stage: 'sahara', start: t(20, 0), end: t(20, 45), picked: 'both', priority: 'want' },
  { id: 'f-levity', name: 'Levity', stage: 'sahara', start: t(21, 15), end: t(22, 20), picked: 'you', priority: 'want', locked: true },
  ...
  { id: 'f-kettama', name: 'Kettama', stage: 'yuma', start: t(18, 15), end: t(19, 30), picked: 'you', priority: 'want' },
  { id: 'f-prospa', name: 'Prospa', stage: 'yuma', start: t(19, 30), end: t(20, 45), picked: 'you', priority: 'want' },
  ...
  { id: 'f-armin', name: 'Armin van Buuren x Adam Beyer', stage: 'quasar', start: t(21, 0), end: t(23, 0), picked: 'you', priority: 'want' },
];
...
export const saturdayActs: Act[] = [
  ...
  { id: 's-nine-inch', name: 'Nine Inch Noize', stage: 'sahara', start: t(20, 0), end: t(20, 45), picked: 'you', priority: 'want' },
  { id: 's-adriatique', name: 'Adriatique', stage: 'sahara', start: t(21, 15), end: t(22, 10) },
  { id: 's-worship', name: 'Worship', stage: 'sahara', start: t(22, 35), end: t(23, 35), picked: 'you', priority: 'must', locked: true },
  ...
  { id: 's-riordan', name: 'Riordan', stage: 'yuma', start: t(15, 0), end: t(16, 15) },
  ...
  { id: 's-sosa', name: 'SOSA', stage: 'yuma', start: t(18, 45), end: t(20, 15), picked: 'you', priority: 'want' },
  { id: 's-bedouin', name: 'Bedouin', stage: 'yuma', start: t(20, 15), end: t(21, 45) },
  { id: 's-boys-noize', name: 'Boys Noize', stage: 'yuma', start: t(21, 45), end: t(23, 0), picked: 'you', priority: 'want' },
  ...
  { id: 's-dj-snake-knock2', name: 'DJ Snake x Knock2', stage: 'quasar', start: t(21, 45), end: t(23, 0), picked: 'you', priority: 'want' },
];
...
export const sundayActs: Act[] = [
  ...
  { id: 'su-karol-g', name: 'KAROL G', stage: 'coachella', start: t(22, 10), end: t(23, 15), picked: 'you', priority: 'want' },
  ...
  { id: 'su-sara-landry', name: "Sara Landry's Blood Oath", stage: 'quasar', start: t(20, 0), end: t(22, 0), picked: 'you', priority: 'want' },
];
...
export const fridayItinerary: ItineraryBlock[] = [
  {
    ...
    subtitle: 'Get bearings, find food, see art, locate stages',
    start: t(13, 0),
    end: t(14, 45),
  },
  {
  ...
  {
    type: 'walk',
    title: '→ Mojave to Outdoor Theatre',
    start: t(15, 45),
    end: t(16, 0),
    note: '~10-15 min walk — arrives right at Dabeull start',
  },
  {
    type: 'act',
    actId: 'f-dabeull',
  ...
  },
  {
    ...
    who: 'you',
    note: 'Leave early for Joost',
  },
  {
    type: 'walk',
    title: '→ Sahara to Gobi',
    start: t(21, 50),
    end: t(22, 0),
    note: '~5-10 min walk',
  },
...
export const saturdayItinerary: ItineraryBlock[] = [
  ...
  },
  {
    ...
    who: 'both',
    note: '★★ BOTH must-see — leave ~5 min early for Worship',
  },
  {
    type: 'walk',
    title: '→ Main to Sahara (speed walk!)',
    start: t(22, 5),
    end: t(22, 20),
    note: '~15-20 min — tight!',
  },
  {
    type: 'act',
    actId: 's-worship',
    ...
    who: 'you',
    note: '★ Your must-see — arrive with ~15 min buffer',
  },
  {
    type: 'gametime',
...
export const sundayItinerary: ItineraryBlock[] = [
  ...
  {
    type: 'walk',
    title: '→ Sahara to Outdoor Theatre',
    start: t(18, 35),
    end: t(18, 50),
    note: '~15 min walk',
  },
  {
    ...
    who: 'both',
    note: 'Arrive a few min late — catch most of set',
  },
  {
    type: 'walk',
    title: '→ OT to Main',
    ...
    note: '~5-8 min walk — Young Thug starts at 7:50!',
  },
  {
    type: 'act',
    actId: 'su-young-thug',
    ...
    who: 'violet',
    note: '★ Violet must-see — leave ~8:30 for Laufey',
  },
  {
    type: 'walk',
    title: '→ Main to OT',
    ...
    note: '~5-8 min walk — arrive with ~7 min buffer',
  },
  {
    type: 'act',
    actId: 'su-laufey',
